  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900">
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <span className="hidden sm:inline text-white/70 ml-2">Orderbook Simulator</span>
              </div>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        <header className="text-center mb-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8 max-w-2xl mx-auto">
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-lg p-4">
              ...
              <div className="text-white/60 text-sm">Exchanges</div>
            </div>
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-lg p-4">
              <div className="text-2xl font-bold text-white">15+</div>
              <div className="text-white/60 text-sm">Order Levels</div>
            </div>
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-lg p-4">
              <div className="text-2xl font-bold text-white">Real-time</div>
              <div className="text-white/60 text-sm">WebSocket</div>
            </div>
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-lg p-4">
                ...
                <div className="grid grid-cols-3 gap-2">
                  {VENUES.map((venue) => (
                    ...
                    >
                      ...
                      <div className="text-xs opacity-75">{venue.description}</div>
                    </button>
                  ))}
                </div>
              </div>
        ...
        {/* Features Section */}
        <section id="features" className="mt-16 py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6">
              ...
              <h3 className="text-xl font-semibold text-white mb-2">Order Simulation</h3>
              <p className="text-white/70">
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6">
              ...
              <h3 className="text-xl font-semibold text-white mb-2">Market Depth Visualization</h3>
              <p className="text-white/70">
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6">
              ...
              <h3 className="text-xl font-semibold text-white mb-2">Risk Warnings</h3>
              <p className="text-white/70">
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6">
              ...
              <h3 className="text-xl font-semibold text-white mb-2">Multi-Venue Support</h3>
              <p className="text-white/70">
